...
./touchup sum_study ws_full1 train1 --buddy dia --xtor full --cohort --patch-cohort --shuffle < TRAIN 2>&1 | tee ws_full1/train1.log
./touchup sum_study ws_full1 train2 --buddy dia --xtor full --cohort --patch-cohort --shuffle < TRAIN 2>&1 | tee ws_full1/train2.log

./touchup sum_study ws_full1 pred --buddy dia --xtor full --cohort --patch-cohort --fallback ws_one/pred < TEST > ws_full1/pred 2> ws_full1/pred.log
./touchup sum_study ws_full1 submit --buddy dia --xtor full --cohort --patch-cohort --fallback ws_one/pred < TEST > ws_full1/submit 2> ws_full1/submit.log

./touchup sum_study ws_full1 pred --buddy dia --xtor full --cohort --patch-cohort --fallback ws_one/pred --fallback2 ws_cli/pred < TEST > ws2_full/pred 2> ws2_full/pred.log
./touchup sum_study ws_full1 submit --buddy dia --xtor full --cohort --patch-cohort --fallback ws_one/pred --fallback2 ws_cli/pred < TEST > ws2_full/submit 2> ws2_full/submit.log
