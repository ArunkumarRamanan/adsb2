...
./touchup sum_study ws_cli train1 --xtor cli --cohort --shuffle --round1 200 < TRAIN 2>&1 | tee ws_cli/train1.log
./touchup sum_study ws_cli train2 --xtor cli --cohort --shuffle --round2 200 < TRAIN 2>&1 | tee ws_cli/train2.log
...
./touchup sum_study ws_one train1 --xtor one --cohort --shuffle --round1 200 < TRAIN 2>&1 | tee ws_one/train1.log
./touchup sum_study ws_one train2 --xtor one --cohort --shuffle --round2 200 < TRAIN 2>&1 | tee ws_one/train2.log
